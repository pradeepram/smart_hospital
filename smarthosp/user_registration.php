...
$select = mysql_query("select username from m_user where username='$username' and DATE(Timecreated)=DATE(NOW())"); 
...
while ($iii = mysql_fetch_array($add2)){
    ...
    echo $result2;
	 ...
	 $add3 = mysql_query("INSERT INTO m_user(emailaddress,username,password,firstname,phone,Gender,roleid,department_id,d_id) VALUES('$email','$username','$password','$firstname','$phone','$gender','$result','$result1','$result2')");
		}
		else {
