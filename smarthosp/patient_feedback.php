...
header('Access-Control-Allow-Origin: *');
	...
	include('dbconfig.php');
		...
		$select = mysql_query("select Name from t_feedback where feedback='$experience'"); 
		$output = mysql_num_rows(@$select);
		if ($output=="0")
		{
	 $add1 = mysql_query("INSERT INTO t_feedback (Name,Doctor,value1,value2,value3,value4,value5,value6,value7,feedback) VALUES ('$patinet','$doctor','$value1','$value2','$value3','$value4','$value5','$value6','$value7','$experience')");
		}
		else {
